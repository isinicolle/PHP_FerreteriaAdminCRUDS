...
<html lang="en">
<?php
if (isset($_GET['idVentaE'])) {

  $idVenta = $_GET['idVentaE'];
  $Ventas = new Ventas();
  $data = $Ventas->getVenta($idVenta);
  ...
  <div class="container">
    <div class="mx-auto main-section" id="myTab" role="tablist">
      <ul class="nav nav-tabs justify-content-center">
        <li class="nav-item">
          <a class="nav-link active" id="form-tab" data-toggle="tab" href="#form" role="tab" aria-controls="form" aria-selected="true"><strong>Editar venta</strong></a>
        </li>
      </ul>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form class="form needs-validation" id="form1" method="post" role="form" autocomplete="off" novalidate>
                <input hidden name="idVenta" value="<?php echo $idVenta?>"/>
                  ...
                  <div class="col-lg-9">
                    <div class="input-group">
                      <select onChange="submit()" style="width:80%" method="post" class="custom-select" id="idproducto" name="idproducto" required>
                        ...
                        ?>
                          <option value=<?php echo $datos[$i]["id_producto"] ?> <?php if ($data[0]['id_producto']==$datos[$i]['id_producto'] ) echo 'selected';?>> <?php echo $datos[$i]["producto"];
                                                                              } ?></option>
                          <?php
                          for ($i = 0; $i < count($datos); $i++) {
                          ...
                          ?>
                          <option disabled value=" "><?php echo $datoscarga[0]["producto"]; ?></option>
                      </select>
                      <div class="input-group">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <input class="form-control" type="date" id="fechacompra" name="fechacompra" disabled required value="<?php echo $data[0]['fecha']; ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <input class="form-control" type="text" value="<?php echo $data[0]['id_cliente'];?>" name="idCliente" style="width:100%" required>
                    <div class="valid-feedback">Correcto</div>
                    <div class="invalid-feedback">Ingrese datos correctos</div>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <input class="form-control" id="Inputcantidad" name="Inputcantidad" value="<?php echo $data[0]['cantidad'];?>" onchange="cargar()" type="number" min="1">
                    <div class="valid-feedback">Correcto</div>
                    <div class="invalid-feedback">Ingrese datos correctos</div>
                  </div>
                </div>
                ...
                if (isset($_REQUEST['enviar'])) {
                  ...
                  $idDireccion = 2;
                  $dates = $Ventas->actualizar($idVenta,$idCliente,$RtnEstado,$isv,$idDireccion,$descuento,$id_producto,$cantidad,$precio);
                }
                ?>
                <div class="form-group row">
